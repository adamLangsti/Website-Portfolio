...
export default {
    ...
    myProjects: 'During my time as an  intern in autumn 2019 I worked at a company called MyIndicators, a company ' +
        ...
        'with the end goal to develop an android application using their IOS model as a design document. I got first hand ' +
        'experience in working with agile methods namely SCRUM, and I also learned how to manage the state in React Native ' +
        'and different navgation libraries aswell, while constantly following a backend structure in the form of API:s.',

    myli: 'Myli is the app that I was designated to create while interning which is intended to be an aid tool that collects ' +
        'large amounts of personal data to create indicators and subsequently help people stop with negative habits such as ' +
